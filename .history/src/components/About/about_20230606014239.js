  ...
  return (
    <>
      <div
        ...
        id="About"
        style={{
          backgroundColor: props.mode === "light" ? "rgb(170, 153, 153)" : "black",
        }}
      >
        ...
        >
          ...
          <div className="containera">
            <p>
              Hey everyone, I'm Anish Kumar Singh, a second-year Computer Science
...
The image animation using gsap is restored.
The container is wrapped in d-flex and align-items-center classes to center the content vertically.
The cards are wrapped in a flex-wrap container and centered using justify-content-center to ensure responsiveness.
The width of the cards is set to "18rem" to maintain their size.
Make sure to adjust the styling and responsiveness according to your requirements.
